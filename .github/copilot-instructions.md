...
- Beim Editieren auf den **Pre-commit-Hook** achten: Code-Änderungen in `automation/`, `collector/`, `diagnos/`, `steuerbox/`, `netzqualitaet/`, `nq/`, `routes/`, `web_api.py` erfordern eine begleitende Card-Aktualisierung in `doc/llm/cards/`.
