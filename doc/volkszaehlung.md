...
**Gesamtzeilen (Code/Doku/Daten):** 279.503 Zeilen  
**Gezählte Dateien:** 530  
...
|---|---|---|---|
| **CSV** | 29 | 168.062 | 60.1% |
| **Python** | 178 | 55.543 | 19.9% |
| **Markdown** | 140 | 24.391 | 8.7% |
| **HTML** | 20 | 15.063 | 5.4% |
| **Shell** | 61 | 4.751 | 1.7% |
| **JSON** | 19 | 4.103 | 1.5% |
| **TXT** | 28 | 3.015 | 1.1% |
...
1. `routes/pac4200.py` — 1.001 Zeilen
