...
| cooldown_s | 3600 s | 1800–5400 s | **Kompressor-Schutzpause (30–90 Min).** EIN-Sperre ab dem zweiten AUS-Ereignis. Schützt den Kompressor vor zu kurzen Zyklen — SD geht aktiv aus, echte Pause statt geräte-interner Mikro-Pausen. Cooldown überstimmt Steuerbox- und Extern-Hold. Im Flow sichtbar als ⏸ Nmin (amber). |
