...
| Host | Pfad | Sync |
|------|------|------|
| Primary (Pi4, 192.0.2.181) | `/srv/pv-system` | `git pull` |
| Failover (Pi4, 192.0.2.105) | `/srv/pv-system` | `scripts/sync_code.sh` |
| Backup (Pi5, 192.0.2.195) | analog | `scripts/sync_code.sh` |
