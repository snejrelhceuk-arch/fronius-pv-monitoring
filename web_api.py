...
MIRROR_SOURCE = os.environ.get('PV_MIRROR_SOURCE', 'Pi5 (192.168.2.195)')
...
def inject_mirror_info():
    ...
    return {
        ...
        'local_ip': os.environ.get('PV_LOCAL_IP', '192.168.2.181'),
...
if __name__ == '__main__':
    ...
    print(f"URL: http://192.168.2.195:{config.WEB_API_PORT}")
