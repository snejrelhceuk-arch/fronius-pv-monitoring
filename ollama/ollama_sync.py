...
Modelfile und aktualisiert das Modell auf dem Ollama-Server.
...
# ── Ollama-Server ────────────────────────────────────────────
OLLAMA_SSH_HOST = 'ollama-server'          # SSH-Alias (192.168.2.116)
...
def push_to_ollama(modelfile_path: Path) -> bool:
    """Kopiere Modelfile zum Ollama-Server und erstelle das Modell."""
