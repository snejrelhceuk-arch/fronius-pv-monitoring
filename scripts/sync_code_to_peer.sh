...
set -euo pipefail
# =============================================================
# Code-Sync: Primary (181) → Failover (fronipi/105)
#
...
FAILOVER_HOST="${FAILOVER_HOST:-jk@192.168.2.105}"
FAILOVER_REPO="${FAILOVER_REPO:-/home/jk/Dokumente/PVAnlage/pv-system}"
