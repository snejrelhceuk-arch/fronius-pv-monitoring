...
#   2 = Kritischer Fehler
#
# Cron: */15 * * * * /home/admin/Dokumente/PVAnlage/pv-system/scripts/monitor_health.sh
# =================================================================
...
# --- 5. Disk-Space ---
DISK_USAGE=$(df --output=pcent /home/admin 2>/dev/null | tail -1 | tr -d ' %')
...
# --- 7. Backup-Aktualität ---
LATEST_BACKUP=$(ls -1t /home/admin/Dokumente/PVAnlage/pv-system/backup/db/daily/*.gz 2>/dev/null | head -1)
